/*
 * e4rat-preload.c - Preload files into page cache
 *
 * e4rat-preload.cc: 2011 Andreas Rid.
 * e4rat-preload-lite.c: 2011 John Lindgren
 * 
 * e4rat-preload.c (e4rat-lite):
...
int main(int argc, char **argv) {
    ...
    if(opt_startup_log_file != 0)
        load_list(opt_startup_log_file);
    else
