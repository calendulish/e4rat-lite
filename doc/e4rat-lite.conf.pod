...
Options can either be declared below a section. Derived from its executable suffix name, each binary owns its own section. Values beyond this section applies to the binary only.
...
After the expiration of this value in seconds e4rat-lite-collect automatically quits collecting. Timeout takes only into account when e4rat-lite-collect was executed as init process. [Default: 120]
